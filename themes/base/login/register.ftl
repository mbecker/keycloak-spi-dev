            ...
            <#if notificationRequired??>
                <div class="${properties.kcFormGroupClass!}">
                    <div class="${properties.kcLabelWrapperClass!}">
                        <label for="mobilenumber" class="${properties.kcLabelClass!}">${msg("mobilenumber")}</label>
                    </div>
                    <div class="${properties.kcInputWrapperClass!}">
                        <input type="text" id="mobilenumber" class="${properties.kcInputClass!}" name="mobilenumber"
                               value="${(register.formData.mobilenumber!'')}" autocomplete="mobilenumber"
                               aria-invalid="<#if messagesPerField.existsError('mobilenumber')>true</#if>"
                        />

                        <#if messagesPerField.existsError('mobilenumber')>
                            <span id="input-error-mobilenumber" class="${properties.kcInputErrorMessageClass!}" aria-live="polite">
